...
Next.js와 Spring Boot를 활용한 풀스택 개발에 열정을 가지고 있으며, 실제 서비스 운영 경험을 바탕으로 성장하고 있습니다.
...
- 📚 **기술 문서**: [DeepWiki](https://deepwiki.com/Mrbaeksang/developers_community)
...
- **최신 기술 스택**: Next.js 15, React 19, Prisma 6, PostgreSQL

### 2. [DevMatch - AI 개발팀 매칭 플랫폼](https://nbe-6-8-2-team08-vaug.vercel.app)
...
> "실제 서비스를 만들고 운영하며 사용자와 함께 성장하는 개발자가 되겠습니다."
